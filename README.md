...
1. Run RandomHandclass.py file to unpack the training dataset and testing dataset.
  1.0 Please download the sign image package files (25signHand_size256_dataset_Test,25signHand_size256_dataset_Train) on Google drive. Please followed this link.
